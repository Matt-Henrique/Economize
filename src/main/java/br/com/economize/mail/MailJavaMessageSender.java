...
public class MailJavaMessageSender {

	// Cria as propriedades necessárias para o envio de email
	public void senderMail(final MailJavaMessage mail) throws UnsupportedEncodingException, MessagingException {
		...
		// Classe anônima que autentica o usuário no servidor de email
